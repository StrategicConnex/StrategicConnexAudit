  ...
  const fetchLogs = useCallback(async (f: typeof filters, activeTab?: Tab) => {
    ...
    try {
      if (t === "siem") {
        ...
        // Los filtros de los events (eventType) no aplican a severidad (critical/warning/info)
        const params = new URLSearchParams();
        // Solo pasamos IP y fechas — el dropdown de tipo de evento se ignora en esta pestaña
