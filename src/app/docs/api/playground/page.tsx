      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            <a href="/docs/api" className="inline-flex items-center gap-1.5 text-[10px] text-muted-fg hover:text-primary transition-colors">
        ...
        <div className="border-t border-border pt-6 flex items-center justify-between text-[10px] text-muted-fg">
          ...
          <a href="/docs/api" className="flex items-center gap-1 hover:text-primary transition-colors">
