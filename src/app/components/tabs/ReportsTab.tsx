...
export function ReportsTab({ 
  ...
  return (
    <div className="space-y-12 relative z-10 font-sans text-foreground">
      ...
      <div>
        <h2 className="text-[28px] font-extrabold text-white tracking-tight">{t('pageTitle')}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="glass-card p-10 flex flex-col justify-between gap-10 group hover:border-primary/20 transition-colors ">
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-2">
              <h4 className="font-extrabold text-white text-[19px] tracking-tight">{t('pdfCardTitle')}</h4>
              <p className="text-[13px] leading-relaxed text-muted-fg">{t('pdfCardDesc')}</p>
            </div>
          </div>
          <DownloadPdfButton
        ...
        <div className="glass-card p-10 flex flex-col justify-between gap-10 group hover:border-chartreuse/20 transition-colors ">
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-2">
              <h4 className="font-extrabold text-white text-[19px] tracking-tight">{t('csvCardTitle')}</h4>
              <p className="text-[13px] leading-relaxed text-muted-fg">{t('csvCardDesc')}</p>
            </div>
          </div>
          <button 
            onClick={async () => {
        ...
        <div className="glass-card p-10 relative overflow-hidden  md:col-span-1">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h4 className="font-extrabold text-white text-[19px] tracking-tight">{t('aiCardTitle')}</h4>
            <p className="text-[13px] leading-relaxed text-muted-fg">{t('aiCardDesc')}</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 border-b border-border pb-10 mb-10 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-end gap-6 w-full md:w-auto">
            <div className="flex flex-col gap-2 w-full sm:w-auto min-w-[200px]">
              <label className="text-[10px] text-muted-fg font-bold uppercase tracking-widest">{t('selectProject')}</label>
  ...
  return (
    <div className="space-y-10 text-foreground/80 font-sans">
      ...
      <div className="backdrop-blur-xl border border-border bg-muted/1 rounded-2xl p-10 relative overflow-hidden">
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest text-primary">{t('visualBadge')}</span>
      ...
      <div className="p-8 bg-muted/1 border border-border rounded-2xl">
        <h4 className="text-[10px] font-bold text-muted-fg uppercase tracking-widest mb-4">{t('visualExecSummary')}</h4>
        <p className="text-sm leading-relaxed whitespace-pre-line text-foreground/80 font-medium">{data.summary}</p>
      </div>

      <div className="space-y-6">
        <h4 className="text-[10px] font-bold text-muted-fg uppercase tracking-widest">{t('visualPerformance')}</h4>
