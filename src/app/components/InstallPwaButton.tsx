  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="relative flex items-center gap-1.5 text-[9px] font-extrabold uppercase tracking-widest px-2.5 py-1.5 rounded-lg border transition-all duration-300 hover:scale-[1.03] text-chartreuse bg-chartreuse/10 border-chartreuse/20 hover:bg-chartreuse/20"
      >
