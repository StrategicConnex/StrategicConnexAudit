...
export default function ToolCatalog() {
  ...
  return (
    <div className="flex flex-col h-full bg-background border border-border rounded-2xl overflow-hidden shadow-2xl">
      {/* Search Header */}
      <div className="p-4 border-b border-border space-y-3 bg-card">
        ...
        <div className="relative flex items-center">
          <Search className="absolute left-3 w-4 h-4 text-muted-fg" />
          <input
            type="text"
            value={searchQuery}
      ...
      {/* Tool List */}
      <div className="flex-1 overflow-y-auto p-4 space-y-2.5 bg-background scrollbar-thin">
        {filteredTools.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 border border-dashed border-border rounded-xl text-center p-4">
            <Terminal className="w-6 h-6 text-muted-fg mb-2 animate-pulse" />
