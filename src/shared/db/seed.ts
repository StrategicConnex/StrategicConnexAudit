...
async function main() {
  ...
  try {
    ...
    logger.info('Seeding Audit Rules...');
    ...
    // Level 3
    logger.info('Seeding Integrations & Data...');
    ...
    logger.info('Seeding Project Audit Rules...');
    ...
    logger.info('Seeding Keyword Targets...');
    ...
    // Level 4
    logger.info('Seeding Integration Sync Logs...');
    ...
    logger.info('Seeding Crawl Results...');
    ...
    logger.info('Seeding Performance Results...');
    ...
    // Level 5
    logger.info('Seeding Internal Links...');
