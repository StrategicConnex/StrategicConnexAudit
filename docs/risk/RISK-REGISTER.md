...
| RSK-09 | ~~2 tool-registries duplicados divergen (ADR-001 no fiel al disco)~~ | 3 | 3 | 9 | TD-11 cerrado: `registry/tool-registry.ts` es solo tipos (C05, 37 líneas) y `core/tool-registry.ts` el único registro runtime — sin divergencia posible | Engineering | ✅ CERRADO (2026-09-25) |
