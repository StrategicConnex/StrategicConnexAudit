...
| RSK-10 | RLS solo en 5/58 tablas (SB-001) — tablas sensibles sin política | 3 | 4 | 12 | CHANGE-003 aplicado (5→9 policies) + 0023 policies de escritura (9→16, incluye tool_runs); revisión RLS incremental del resto (52 tablas server-side) | Engineering | 🔄 PARCIAL (9→16/58; resto sin política — acceso solo server-side) |
